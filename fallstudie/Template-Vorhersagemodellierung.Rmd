---
title: "Vorhersagemodellierung Autopreis"
...
```{r}
train <- read.csv2(here::here("data", "tips_train.csv"))
anwendung <- read.csv2(here::here("data", "tips_test.csv"))

str(train)  # Datenstruktur
```

<!-- Hier müssen Sie die richtigen Daten einlesen -->
